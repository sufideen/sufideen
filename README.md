...
| Workloads on the platform | [rag-support-agent-poc](https://github.com/sufideen/rag-support-agent-poc), [avd-bicep-lz](https://github.com/sufideen/avd-bicep-lz) | AI and virtual-desktop workloads |
...
Executive, SOC and Zero Trust dashboards as Azure Workbooks, 5 Sentinel analytics rules, and secretless alerting (Action Group → Logic App → Teams) using Key Vault and managed identity. Also includes a private AKS + Application Gateway WAF web platform.
**Skills:** Sentinel, KQL, Workbooks, Logic Apps, AKS, Checkov/PSRule

### 3. Azure Landing Zone GitOps Engine — [azl-bicepdeploy](https://github.com/sufideen/azl-bicepdeploy)
...
### 4. Secure Bicep Pipelines — [securebicep](https://github.com/sufideen/securebicep)
...
### 5. RAG Support Agent on Azure AI Foundry — [rag-support-agent-poc](https://github.com/sufideen/rag-support-agent-poc)
...
### 6. Azure Virtual Desktop Pilot — [avd-bicep-lz](https://github.com/sufideen/avd-bicep-lz)
